...
<?php $test = $this->db->get_where('permintaan', array('id_permintaan'=>$permintaan['id_permintaan']))->row_array();
$tet = $this->db->get_where('tb_sukucadang', array('id_sc'=>$permintaan['id_sc']))->row_array() ?>
<form id="form" action="<?php echo site_url('permintaan/create_action1'); ?>" method="post">
      ...
      <div class="col-lg-4">
        <div class="position-relative p-3 bg-white">
          <table width="100%">
            ...
            <td>
              <div>
                 <input type="text" name="nama" id="nama" value="<?= $test['nama']?>" class="form-control" required> 
            ...
            <td>
              <div class="form-group">
                <textarea name="alamat" id="alamat" class="form-control" required><?= $test['alamat']?></textarea>
              </div>
            </td>
            </tr>
            <td style="vertical-align:top" width:30%>
            ...
            <td>
              <div class="form-group">
                <input type="text" name="telepon" id="telepon" value="<?= $test['telepon']?>" class="form-control" required>
              </div>
            </td>
            <tr>
            <th style="vertical-align:top" width:30%>
            ...
            <td>
              <div class="form-group">
                <input type="text" name="no_pol" id="no_pol" value="<?= $test['no_pol']?>" class="form-control" required>
              </div>
            </td>
            </tr>
            <!--             <tr>
      ...
      <div class="col-lg-3">
        <div class="position-relative p-3 bg-white">
          <div align="right" class="form-group">
            ...
            <h4><span name="id_permintaan" id="id_permintaan"><?= $permintaan['id_permintaan'] ?></span></h4>
              ...
              <tr class="autonumber">
                ...
                <td>
                  <div class="form-group input-group">
                    <input type="text" name="id_sc[]" id="id_sc-1" value="<?= $tet['id_sc'] ?>" class="form-control">
                ...
                <!-- <td style="display:none;"> <input type="text" name="id_sc[]" value="<?= $tet['id_sc'] ?>"  id="id_sc-1" class="form-control"></td> -->
                <td> <input type="text" name="nama_sc[]" value="<?= $tet['nama'] ?>"  id="nama_sc-1" class="form-control"></td>
                <td> <input type="number" name="jumlah[]" id="jumlah_item-1" value="<?= $permintaan['jumlah'] ?>"  class="form-control"></td>
                <td> <input type="text" name="stok[]"value="<?= $tet['stok'] ?>"  id="stok_sc-1" class="form-control" readonly></td>
          ...
          <table width="100%">
            <tr>
              <div align="right" class="form-group">
                ...
                <td>
                  <textarea id="note" name="note" rows="3" class="form-control" value=""><?= $test['note']?></textarea>
                </td>
              </div>
            </tr>
          </table>
