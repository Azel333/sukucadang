...
<div class="box">
	...
	<?php $result = $this->db->get_where('tb_sukucadang', array('id_sc'=>$stok['id_sc']))->row_array(); ?>
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<form action="<?=site_url('stock/process1/'. $stok['id_stok'])?>" method="post">
					...
					<div class="form-group input-group">
						<input type="hidden" name="id_sc[]" value="<?= $result['id_sc'] ?>" id="id_sc-1">
						<input type="text" name="id_sc[]" value="<?= $result['id_sc'] ?>" id="id_sc-1" class="form-control" readonly="true" required autofocus>
					...
					<div class ="form-group">
						...
						<input type="text" name="no_stok[]" value="<?= $stok['no_stok'] ?>" class="form-control"/>
					</div>
					<div class ="form-group">
						<div class="row">
							<div class="col-md-8">
								<label for="nama_sc">Nama Sukucadang *</label>
								<input type="text"  name="nama[]" value="<?= $result['nama'] ?>" id="nama-1" class="form-control" readonly>
							</div>
							<div class="col-md-4">
								<label for="nama_sc">Tipe *</label>
								<input type="text"  name="tipe[]" id="tipe-1" value="<?= $result['tipe'] ?>" class="form-control" readonly>
							</div>
						</div>
					</div>
					<div class ="form-group">
						<div class="row">
							<div class="col-md-4">
								...
								<input type="text" name="satuan[]" value="<?= $result['satuan'] ?>" id="satuan-1" value="-" class="form-control" readonly>
						</div>	
						<div class="col-md-4">
							<label for="satuan">Stok Awal</label>
							<input type="text" name="stok[]" id="stok-1" value="<?= $result['stok'] ?>" class="form-control"readonly>
						</div>
						<div class="col-md-4">
							<label for="satuan">Maksimum</label>
							<input type="text" name="kondisi[]" id="kondisi-1" value="<?= $result['kondisi'] ?>" class="form-control"readonly>
						</div>
					</div>
				</div> 
						<!-- <div class ="form-group">
							<label>Detail *</label>
							<input type="text"  name="detail[]" id="detail-1" value="<?= $stok['detail'] ?>" class="form-control" placeholder="kulakan / tambahan / etc"required> 
						</div> -->
						<div class ="form-group">
						...
						<div class ="form-group">
							<label>Jumlah *</label>
							<input type="number"  name="jumlah[]" placeholder="maksimum input tersisa <?= $result['kondisi'] - $result['stok']?>" value="<?= $stok['jumlah'] ?>" id="jumlah-1" class="form-control"required> 
						</div>
						</div>
						</div>
...
<script>
  ...
  function addRow() {
	...
	<div>\
					...
					<div class="form-group input-group">\
						<input type="hidden" name="id_sc[]" id="id_sc-' + row + '">\
